  ...
  parseEMSG_(reference, emsgSchemeIdUris, box) {
    ...
    if ((emsgSchemeIdUris && emsgSchemeIdUris.includes(schemeId)) ||
      ...
      if (schemeId == 'urn:mpeg:dash:event:2012') {
        // When value is '3', the messageData contains the new manifest
        if (value == '3') {
          this.playerInterface_.onMpdExpireUpdate(messageData);
        } else {
 ...
 *   onMpdExpireUpdate: function(Uint8Array),
 * }}
 *
 ...
 * @property {(function(Uint8Array)|null|undefined)} onMpdExpireUpdate
 *   Called when an embedded 'emsg' box contains new manifest data for
 *   MPD update.
 */
